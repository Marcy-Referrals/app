...
export default function Home() {
  ...
  <div className='relative z-10 w-[90%] pb-20 m-auto pt-5'>
    <h1 className=''>REFERRAL MILESTONES</h1>
  ...
  
  {
    pointsData.map((milestone) => {
      return (
        <div className="relative z-10 w-[90%] m-auto py-5 border-t-[#261f1d] flex gap-5 justify-between border-t-[0.1rem]">
          <h1 className=" font-medium text-[2rem] w-[29rem]">{milestone.action}</h1>
          <h1>→</h1>
          <h1 className="text-[2rem] font-medium">{milestone.points} POINTS</h1>
        </div>
      );
    })
  }
